...
//    */
    ...
    public int repeats(int extra,int nextInstall) {
//        System.out.println(Util.install);
        int amount20 = Math.round((int) (extra * (20.0f / 100.0f)));
        int amount40 = Math.round((int) (extra * (40.0f / 100.0f)));
        int amount60 = Math.round((int) (extra * (60.0f / 100.0f)));
        int amount80 = Math.round((int) (extra * (80.0f / 100.0f)));
        int amount99 = Math.round((int) (extra * (99.0f / 100.0f)));
